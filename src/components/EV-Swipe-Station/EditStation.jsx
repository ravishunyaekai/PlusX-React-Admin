...
const EditStation = () => {
    ...
    const validateForm = () => {
        const fields = [
            ...
            { name: "slotNumber",    value: slotNumber,    errorMessage: "No. Of Slot Numberis required"},
        ];
    ...
    const handleSubmit = (e) => {
        ...
        if (validateForm()) {
            ...
            postRequestWithToken('swipe-station-update', obj, async (response) => {
    ...
    const fetchDetails = () => {
        ...
        postRequestWithToken('swipe-station-details', obj, (response) => {
            ...
            if (response.status === 1) {
                ...
                setSlotNumber(data?.number_of_slot);
