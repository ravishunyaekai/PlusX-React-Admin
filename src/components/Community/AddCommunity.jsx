...
const AddCommunity = () => {
    ...
    const validateForm = () => {
        ...
        chargers.forEach((charger, index) => {
            const chargerId = charger.chargers.trim();
    ...
    const handleSubmit = (e) => {
        ...
        if (validateForm()) {
            const completeChargers = chargers.filter(f => f.chargers.trim() !== '' && f.kw.trim() !== '');
            const chargersValues = completeChargers.map(f => f.chargers);
