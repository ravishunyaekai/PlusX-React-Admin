...
const AddBike = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (validateForm()) {
            ...
            postRequestWithToken('bike-add', obj, async (response) => {
    ...
    const fetchDetails = () => {
        ...
        postRequestWithToken('bike-swap-data', obj, (response) => {
            if (response.code === 200) {
    ...
    return (
        <div className={styles.addShopContainer}>
            ...
            <div className={styles.addHeading}>Add Bike</div>
            <div className={styles.addShopFormSection}>
                ...
                <form className={styles.formSection} onSubmit={handleSubmit}>
                    ...
                    <div className={styles.row}>
                        ...
                        {/* <div className={styles.addShopInputContainer}>
                            <label className={styles.addShopLabel} htmlFor="regsDate">Regs. Date</label>
                            <InputMask
                                mask    = "99-99-9999"
                                value   = {regsDate}
                                onChange = {(e) => {
