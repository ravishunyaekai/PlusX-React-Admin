...
const SubHeader = ({ heading, fetchFilteredData, dynamicFilters, filterValues, addButtonProps, searchTerm, count, modalTitle, setRefresh,apiEndPoint, nameKey, setDownloadClicked, handleDownloadClick, scheduleDateChange, scheduleFilters, areaOptions, areaSelected, handleArea, rowOptions, rowSelected, handleRowperPagePage }) => {
    ...
    const cardArray = [ "App Signup List", "Portable Charger Booking List", "Offer List", "Subscription List", "Coupon List", "Register Interest List", "Ev Buy & Sell List", "Ev Specialized Shop List", "Ev Insurance List", "Ev Discussion Board List", "Ev Rider Clubs List", "EV Guide List", "Electric Bikes Leasing List", "Electric Cars Leasing List", "Public Chargers List", "Failed POD Booking List", "Failed Pick & Drop Booking List", "Deleted Account List", "Failed RSA Booking List", 'EV Charger List', 'EV Accessories List', 'Ev Road Assitance Booking List', "RSA Offline Leads", "Pick & Drop Booking List", "Community List", "Resident List", "Invoice List", "Session History", "Invoice History"]

    const showCard = cardArray.includes(heading);
    const headingArray = [ "Drivers List",  "Portable Charger List", "Portable Charger Invoice List", "Portable Charger Slot List", "Pick & Drop Invoice List", "Pick & Drop Time Slot List", "Charger Installation Booking List", "Notification List", "EV Pre-Sale Testing Booking List", "Time Slot List", "Ev Road Assistance Invoice List", "Ev Specialized Shop Service List", "Ev Specialized Shop Brand List", "Add POD List", "POD Brand List", "POD Device List","POD Area List", "Customer POD Booking List", "Partners List", "Truck List", 'Bike List', 'Swipe Station List', 'EV Charger Brand List', 'Roadside Assistance Slot List', 'EV Products & Installation', "EV Accessories Bookings", "Fixed Charger Bookings", "Charger Share List",'Top Rated Area'] //"Ev Road Assitance Booking List", "Pick & Drop Booking List", 
