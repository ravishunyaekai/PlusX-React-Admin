...
const SubHeader = ({ heading, fetchFilteredData, dynamicFilters, filterValues, addButtonProps, searchTerm, count, modalTitle, setRefresh,apiEndPoint, nameKey, setDownloadClicked, handleDownloadClick, scheduleDateChange, scheduleFilters, areaOptions, areaSelected, handleArea, rowOptions, rowSelected, handleRowperPagePage }) => {
    ...
    const shouldShowFilterButtonArr = [  "Offer List", "Time Slot List" , "Register Interest List","Ev Buy & Sell List","Portable Charger List",'Ev Specialized Shop List', "Ev Specialized Shop Service List", "Ev Specialized Shop Brand List","Ev Discussion Board List", "Ev Rider Clubs List" ,  "Notification List", "Electric Cars Leasing List", "Electric Bikes Leasing List", "EV Guide List", 'Bike List', 'Swipe Station List', 'EV Charger Brand List',"Community List", "Resident List"]
    const shouldShowFilterButton = !shouldShowFilterButtonArr.includes(heading)

    const shouldShowSearchButtonArr = [ "Ev Road Assistance Invoice List" , "Pick & Drop Invoice List", "Notification List", "Ev Buy Sell List", "Offer List", "Pick & Drop Time Slot List","Portable Charger Slot List" ,"Time Slot List",'Top Rated Area',"Community List", "Resident List"]
    const shouldShowSearchButton = !shouldShowSearchButtonArr.includes(heading)

    const shouldShowAddButtonArr = ["App Signup List", "Portable Charger Booking List", "Pick & Drop Booking List", "Portable Charger Invoice List", "Notification List", "Pick & Drop Invoice List", "Charger Installation Booking List", "Ev Road Assitance Booking List","Road Assistance Invoice List", "Board List", "Insurance List", "Buy Sell List", "Interest List","Subscription List", "EV Pre-Sale Testing Booking List", "Ev Road Assistance Invoice List", "Ev Discussion Board List","Ev Insurance List", "Ev Buy & Sell List", "Register Interest List", "Customer POD Booking List", "Failed POD Booking List", "Failed Pick & Drop Booking List", "Deleted Account List", "Failed RSA Booking List", "EV Accessories Bookings", "Fixed Charger Bookings", "Charger Share List",'Top Rated Area', "Session History", "Invoice History"] ; 
    ...
    const cardArray = [ "App Signup List", "Portable Charger Booking List", "Offer List", "Subscription List", "Coupon List", "Register Interest List", "Ev Buy & Sell List", "Ev Specialized Shop List", "Ev Insurance List", "Ev Discussion Board List", "Ev Rider Clubs List", "EV Guide List", "Electric Bikes Leasing List", "Electric Cars Leasing List", "Public Chargers List", "Failed POD Booking List", "Failed Pick & Drop Booking List", "Deleted Account List", "Failed RSA Booking List", 'EV Charger List', 'EV Accessories List', 'Ev Road Assitance Booking List', "RSA Offline Leads", "Community List", "Resident List", "Invoice List", "Session History", "Invoice History"]

    const showCard = cardArray.includes(heading);
    const headingArray = [ "Drivers List",  "Portable Charger List", "Portable Charger Invoice List", "Portable Charger Slot List", "Pick & Drop Booking List", "Pick & Drop Invoice List", "Pick & Drop Time Slot List", "Charger Installation Booking List", "Notification List", "EV Pre-Sale Testing Booking List", "Time Slot List", "Ev Road Assistance Invoice List", "Ev Specialized Shop Service List", "Ev Specialized Shop Brand List", "Add POD List", "POD Brand List", "POD Device List","POD Area List", "Customer POD Booking List", "Partners List", "Truck List", 'Bike List', 'Swipe Station List', 'EV Charger Brand List', 'Roadside Assistance Slot List', 'EV Products & Installation', "EV Accessories Bookings", "Fixed Charger Bookings", "Charger Share List",'Top Rated Area'] //"Ev Road Assitance Booking List", 
